...
impl Organization {
    pub fn new(object: Object, id: String, name: String, slug: Option<String>, max_allowed_memberships: i32, public_metadata: serde_json::Value, private_metadata: serde_json::Value, created_at: i64, updated_at: i64) -> Organization {
        Organization {
            object,
            id,
            name,
