...
pub struct UpdateOrganizationMembershipMetadataRequest {
...
impl UpdateOrganizationMembershipMetadataRequest {
    pub fn new() -> UpdateOrganizationMembershipMetadataRequest {
