...
pub async fn ban_user(configuration: &configuration::Configuration, user_id: &str) -> Result<crate::models::User, Error<BanUserError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/{user_id}/ban", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
...
pub async fn delete_user(configuration: &configuration::Configuration, user_id: &str) -> Result<crate::models::DeletedObject, Error<DeleteUserError>> {
    let local_var_configuration = configuration;
...
pub async fn disable_mfa(configuration: &configuration::Configuration, user_id: &str) -> Result<crate::models::DisableMfa200Response, Error<DisableMfaError>> {
    let local_var_configuration = configuration;
...
pub async fn get_o_auth_access_token(configuration: &configuration::Configuration, user_id: &str, provider: &str) -> Result<Vec<crate::models::GetOAuthAccessToken200ResponseInner>, Error<GetOAuthAccessTokenError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/{user_id}/oauth_access_tokens/{provider}", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id), provider=crate::apis::urlencode(provider));
...
pub async fn get_user_list(configuration: &configuration::Configuration, email_address: Option<Vec<String>>, phone_number: Option<Vec<String>>, external_id: Option<Vec<String>>, username: Option<Vec<String>>, web3_wallet: Option<Vec<String>>, user_id: Option<Vec<String>>, organization_id: Option<Vec<String>>, query: Option<&str>, offset: Option<i32>, limit: Option<i32>, order_by: Option<&str>) -> Result<Vec<crate::models::User>, Error<GetUserListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = email_address {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("email_address".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("email_address", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = phone_number {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("phone_number".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("phone_number", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = external_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("external_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("external_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = web3_wallet {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("web3_wallet".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("web3_wallet", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = organization_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("organization_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("organization_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn get_users_count(configuration: &configuration::Configuration, email_address: Option<Vec<String>>, phone_number: Option<Vec<String>>, external_id: Option<Vec<String>>, username: Option<Vec<String>>, web3_wallet: Option<Vec<String>>, user_id: Option<Vec<String>>, query: Option<&str>) -> Result<crate::models::TotalCount, Error<GetUsersCountError>> {
    let local_var_configuration = configuration;
...
pub async fn unban_user(configuration: &configuration::Configuration, user_id: &str) -> Result<crate::models::User, Error<UnbanUserError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/{user_id}/unban", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn update_user_metadata(configuration: &configuration::Configuration, user_id: &str, update_user_metadata_request: Option<crate::models::UpdateUserMetadataRequest>) -> Result<crate::models::User, Error<UpdateUserMetadataError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/{user_id}/metadata", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn users_get_organization_memberships(configuration: &configuration::Configuration, user_id: &str, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::OrganizationMemberships, Error<UsersGetOrganizationMembershipsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/{user_id}/organization_memberships", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn verify_password(configuration: &configuration::Configuration, user_id: &str, verify_password_request: Option<crate::models::VerifyPasswordRequest>) -> Result<crate::models::VerifyPassword200Response, Error<VerifyPasswordError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/{user_id}/verify_password", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn verify_totp(configuration: &configuration::Configuration, user_id: &str, verify_totp_request: Option<crate::models::VerifyTotpRequest>) -> Result<crate::models::VerifyTotp200Response, Error<VerifyTotpError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/{user_id}/verify_totp", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
